...
const Footer = () => {
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <Link href = {'/tshirts'}><p className="text-gray-600 hover:text-pink-500">Tshirts</p></Link>
          </li>
          <li>
          <Link href = {'/hoodies'}><p className="text-gray-600 hover:text-pink-500">Hoodies</p></Link>
          </li>
          <li>
          <Link href = {'/tvs'}><p className="text-gray-600 hover:text-pink-500">TVs</p></Link>
          </li>
          <li>
          <Link href = {'/mugs'}><p className="text-gray-600 hover:text-pink-500">Mugs</p></Link>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 TechThreads.com — All Rights Reserved
      </p>
